...
public class MoveTo : MonoBehaviour {
    ...
    void snakeWander()
    {
        ...
        {
            NewTarget = distPlayerSnake + (Random.insideUnitSphere * WanderRadius);     //Generate a circle around the snake of radius 'WanderRadius' and choose a random new point in that circle
    ...
    void snakeFlee()
    {
        ...
        if(snakeSpooked)      
        {
            ...
            if(!hasGoal)
            {
                ...
                distPlayerSnake = (transform.position + player.transform.forward);            
